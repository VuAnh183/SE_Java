...
public class Query {
   ...
   *
   * @effects
   *   if there are no matches, returns null, else returns an iterator for the
   * @return
   *   an iterator for the matching documents of this query || null
   */
